...
class ConfigurationManager:
    ...
    @staticmethod
    def save_config(config_data: Dict[str, Any], config_path: str = 'config.json') -> Tuple[bool, str]:
        """
    ...
    @staticmethod
    def load_config(config_path: str = 'config.json', default_config: Dict = None) -> Dict[str, Any]:
        """
