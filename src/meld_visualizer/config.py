...
# --- Theme Configuration ---
THEMES = {
    "Cerulean (Default)": dbc.themes.CERULEAN,
...
def load_config():
    ...
    """
    default_config = {
        "default_theme": "Cerulean (Default)",
        "plotly_template": "plotly_white",
        "graph_1_options": ["YPos", "ZPos", "SpinVel"],
        "graph_2_options": ["XPos", "ZPos", "SpinVel"],
        "plot_2d_y_options": ["XPos", "YPos", "ZPos"],
        "plot_2d_color_options": ["FRO", "ToolTemp"],
    ...
    try:
        ...
        if "plotly_template" not in user_config:
            ...
            final_config["plotly_template"] = (
                "plotly_dark" if final_config["default_theme"] in DARK_THEMES else "plotly_white"
            )
        return final_config
...
def get_responsive_plot_style(plot_type="scatter_3d", viewport_width=1920):
    ...
    """
    from .constants import PLOT_TYPE_MODIFIERS, RESPONSIVE_PLOT_CONFIG
...
def get_responsive_plotly_config(plot_type="scatter_3d"):
    ...
    base_config = {
        ...
        "modeBarButtonsToRemove": (
            ["pan2d", "select2d", "lasso2d", "autoScale2d"] if plot_type == "time_series_2d" else []
        ),
