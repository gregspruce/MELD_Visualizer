...
from dash import MATCH, Input, Output, State, callback, ctx, no_update
...
def register_filter_callbacks(app=None):
    ...
    def sync_filter_controls(
        lower_in, upper_in, s_min_in, s_max_in, column_ranges, slider_val, custom_filter_col
    ):
        """
