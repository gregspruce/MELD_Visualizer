        ...
        if current_bead_width > avg_track_spacing:
            ...
            for test_radius in [1.5, 2.0, 2.5, 3.0]:
                ...
                if test_width >= required_bead_width:
                    print("    [OK] This would provide sufficient overlap!")
