...
class PlaywrightMCPTestRunner:
    ...
    async def test_page_interactions(self):
        ...
        try:
            ...
            if "Please upload a CSV file" in visible_text or "Volumetric Data Plotter" in visible_text:
    ...
    async def test_performance(self):
        ...
        try:
            ...
            if load_time < 10.0:  # Should load within 10 seconds
                ...
                self.add_result("performance", "failed", f"Page load too slow: {load_time:.2f} seconds")
    ...
    async def playwright_screenshot(self, name: str, full_page: bool = False, 
                                  save_png: bool = True, downloads_dir: str = None):
    ...
    async def playwright_get_visible_html(self, max_length: int = 20000, 
                                        remove_scripts: bool = True, clean_html: bool = False):
