...
class TestFileValidator:
    ...
    def test_validate_file_upload_invalid_extension(self):
        ...
        invalid_files = ["malware.exe", "script.js", "document.docx", "archive.zip", "config.ini"]
...
class TestInputValidator:
    ...
    def test_sanitize_numeric_input_invalid_values(self):
        ...
        invalid_values = ["not_a_number", None, [], {}, float("inf"), float("-inf"), float("nan")]
    ...
    def test_sanitize_column_name_invalid(self):
        ...
        invalid_cases = [("InvalidColumn", None), ("", None), (None, None), (123, None), ([], None)]
    ...
    def test_sanitize_gcode_line_valid(self):
        ...
        valid_lines = ["G1 X10 Y20 Z5", "G0 X0 Y0", "M104 S200", "G28 X Y Z"]
...
class TestConfigurationManager:
    ...
    def test_save_config_valid(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                success, message = ConfigurationManager.save_config(
    ...
    def test_save_config_too_large(self):
        ...
        large_value = (
            "x" * 90
        )  # Within individual value limit but creates large config when multiplied
    ...
    def test_load_config_file_too_large(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                default_config = {"default_theme": "light"}
                loaded_config = ConfigurationManager.load_config(
                    "large_config.json", default_config
                )
...
class TestSecureParseGcode:
    ...
    @patch(
        "meld_visualizer.utils.security_utils.InputValidator.sanitize_gcode_line",
